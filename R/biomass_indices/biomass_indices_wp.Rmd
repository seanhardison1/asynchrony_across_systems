---
title: "White perch biomass index development"
output:
...
set.seed(123)
if (process){
  samps <- sdmTMBextra::predict_mle_mcmc(hurd_mod, 
                                         mcmc_iter = 201, 
                                         mcmc_warmup = 200)
...
pred_out_seas_wp <- pred_out_seas %>% 
  as_tibble()
save(pred_out_seas_wp,
